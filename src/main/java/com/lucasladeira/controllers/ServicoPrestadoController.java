...
public class ServicoPrestadoController {
	...
	public void salvar(@RequestBody @Valid ServicoPrestadoDTO dto) {
	...
	@GetMapping("/{id}")
	public ServicoPrestado pesquisarPorId(@PathVariable Integer id) {
		return servicoPrestadoService.procurarPorId(id);
	}
}
